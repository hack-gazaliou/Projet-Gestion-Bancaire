...
from Controleur.controleur import Controller, DECOUVERT_MAX # noqa: E402
...
def test_virement_refuse_solde_insuffisant(controller, mock_session):
    ...
    with patch('Controleur.controleur.Compte.obtenir', side_effect=[compte_source, compte_cible]):
