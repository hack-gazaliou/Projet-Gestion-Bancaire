...
class AccountViewWidget(OperationWidget):
    ...
    def create_interface(self):
        ...
        accounts = self.get_account_list(self.client_id)#TODO: remplacer par une vraie requete SQL
    ...
    def _create_account_card(self, account):
        ...
        account_money_label = QLabel(f"Solde: TODO")
    ...
    def _on_close_account(self, account) -> None:
        ...
        # À implémenter
        print(f"Clôturer le compte {account['id']} ({account['nom']}) pour le client {self.client_id}")
